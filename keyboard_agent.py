...
env = envs.generic_env.GenericEnv(dims=(20,20), features=[{'class':'feature','type':'fire','start_number':3,'color':'red', 'moveTo':'moveToFire', 'position':'random-free-clustered', 'refresh-rate':1.00},
                                                          {'class':'feature','type':'water','start_number':5,'color':'blue', 'moveTo':'moveToWater', 'position':'random-free-clustered', 'refresh-rate':1.00}],
